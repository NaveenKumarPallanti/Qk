...
namespace UnitTests.Components
{
    ...
    /// <summary>
    /// Class containing unit tests for testing ProductList.razor
    /// </summary>
    public class ProductListTests : BunitTestContext
    {
        ...
        /// <summary>
        /// Test that one of the recipes stored in products.json is in the main page
        /// </summary>
        [Test]
        ...
        public void SubmitRating_Valid_ID_Click_Unstared_Should_Increment_Count_And_Check_Star()
        {
            ...
            // Get the ID of the recipe to select
            var id = "MoreInfoButton_scallion-ginger-beef-and-tofu-stirfry";
